...
void test_add_product_serv() { 
	//DinamicProduct prd = create_product( 1, "laptop", "acer", "aspire", 2500, 2 );
	DinamicInventory* inv = create_dinamic_inventory();
	DinamicService serv = {inv};
	
	int err_cnt = 0;
	char** error_list = init_error_message(7, 30);
	add_product_serv(&serv, 1, "laptop", "acer", "aspire", 2500, 2, error_list, &err_cnt);
	assert(err_cnt == 0);
	assert(inv->length == 1);
	assert(inv->products[0].id == 1);

	int prev_q = 2;
	add_product_serv(&serv, 1, "laptop", "acer", "aspire", 2500, 2 + 10, error_list, &err_cnt);
	assert(err_cnt == 0);
	assert(inv->length == 1);
	assert(inv->products[0].id == 1);
...
void test_update_product_price_serv() {
	...
	int err_cnt = 0;
	char** err_lst = init_error_message(3, 30);
	...
	destroy_error_message(err_lst, 3);
	destroy_dinamic_service(&serv);
}
...
void test_sort_by_price() {
	DinamicProduct prd1 = create_product( 1, "laptop", "acer", "aspire", 2500, 2 );
	DinamicProduct prd2 = create_product( 2, "display", "lenovo", "asdasd", 1000, 10 );
	DinamicProduct prd3 = create_product( 3, "asdasd", "dassa", "asdasdaw", 4000, 5 );
	DinamicInventory* inv = create_dinamic_inventory();
	DinamicService serv = { inv };
...
void test_compare_price_descending() {
	...
	destroy_product(&prd2);
	destroy_product(&prd3);
}
...
void test_filter_by_manufacturer() {
	DinamicProduct prd1 = create_product( 1, "laptop", "acer", "aspire", 2500, 2 );
	DinamicProduct prd2 = create_product( 2, "display", "lenovo", "asdasd", 1000, 10 );
	DinamicProduct prd3 = create_product( 3, "asdasd", "acer", "asdasdaw", 4000, 5 );
	DinamicInventory* inv = create_dinamic_inventory();
	...
	destroy_dinamic_inventory(print_inv);
	free(err_msg);
	destroy_dinamic_service(&srv);
}

void test_filter_by_price() {
	DinamicProduct prd1 = create_product( 1, "laptop", "acer", "aspire", 2500, 2 );
	DinamicProduct prd2 = create_product( 2, "display", "lenovo", "asdasd", 4000, 10 );
	DinamicProduct prd3 = create_product( 3, "asdasd", "acer", "asdasdaw", 4000, 5 );
	DinamicInventory* inv = create_dinamic_inventory();
	DinamicService srv = { inv };
...
void test_filter_by_quantity() {
	DinamicProduct prd1 = create_product( 1, "laptop", "acer", "aspire", 2500, 10 );
	DinamicProduct prd2 = create_product( 2, "display", "lenovo", "asdasd", 4000, 10 );
	DinamicProduct prd3 = create_product( 3, "asdasd", "acer", "asdasdaw", 4000, 5 );
	DinamicInventory* inv = create_dinamic_inventory();
	DinamicService srv = { inv };
...
void test_service_methods() {
	test_add_product_serv(); // has leaks
